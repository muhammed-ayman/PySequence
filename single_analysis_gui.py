...
def reverse_trascriptase_sub():
	...
	def reverse_transcriptase_local():
	...
	#defining buttons
	complementbtn = Button(window, relief="solid",borderwidth=4, padx=40, text="Reverse Transcriptase",width=15,font="Helvetica 16 bold italic",fg="dark blue",bg="dark cyan",command=reverse_transcriptase_local)
...
def main():
	...
	def reverse_trascriptase_local():
		window.destroy()
		reverse_trascriptase_sub()
	...
	reverseTranscriptase = Button(window, relief="solid", borderwidth=4, padx=40, text="Reverse Transcriptase",width=15,font="Helvetica 16 bold italic",fg="dark blue",bg="dark cyan",command=reverse_trascriptase_local)
